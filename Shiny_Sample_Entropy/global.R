...
SamplingFrequencyStats <- function(dataFrame,longest_gap_tolerated=1500, lower_limit=1.02399900000000, upper_limit=1.02500010000000){
...
tableDisplayFragmentation <- function(dataFrame, column_name){
  ...
  Patient_ID   <- gsub("(HARVEY_[FT]G)_([a-zA-Z0-9]+).*", "\\1_\\2", elemListName) 
